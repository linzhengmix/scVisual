---
title: "drawLegend: Custom Legend Drawing"
author: "mixfruit"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{drawLegend: Custom Legend Drawing}
...
The `drawLegend` function creates custom legends for visualizations. This utility function allows you to create highly customized legends that can be added to other plots, providing more flexibility than default ggplot2 legends.
...
- `orientation`: Legend orientation ("vertical" or "horizontal", default: "vertical")
...
You can use `drawLegend` to create custom legends for other visualizations:
...
The function returns a ggplot2 object representing the custom legend, which can be further customized using ggplot2 functions:
...
- Use `drawLegend` when you need more flexibility than default ggplot2 legends
- Adjust `orientation` to place the legend horizontally or vertically
- Combine with `gridExtra` or similar packages to arrange legends with other plots
