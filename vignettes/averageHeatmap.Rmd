---
title: "averageHeatmap: Average Expression Heatmap"
author: "mixfruit"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{averageHeatmap: Average Expression Heatmap}
...
The `averageHeatmap` function creates heatmaps displaying average gene expression levels across clusters. This visualization is useful for identifying patterns of gene expression across different cell populations.
...
You can customize the heatmap by adjusting clustering, scaling, and grouping:
...
The function returns a ComplexHeatmap object, which can be further customized using ComplexHeatmap functions:
...
- Adjust `cluster_rows` and `cluster_cols` to control clustering behavior
- Use `group_by` to compare expression patterns across different metadata groups
